                    ...
                    <div class="section__title section__title--2 text-left">
                        <?php
                            if(isset($_GET['id_kategori'])){
                                $id = $_GET['id_kategori'];
                                $sqlSelect = "SELECT * FROM kategori where id=$id";
                                $resultSelect = mysqli_query($conn, $sqlSelect);
                                $kategori = mysqli_fetch_assoc($resultSelect); 
                            }          
                    ?>
                        <h2 class="title__line">Menampilkan Semua Barang, Berdasarkan kategori : <?= $kategori['nama'] ?></h2>
                    </div>
                        <div class="row">
                            <div class="product__list another-product-style">
                                ...
                                <?php
                                    $sql = "SELECT * from barang where id_kategori=".$_GET['id_kategori'];
